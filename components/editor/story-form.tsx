...
export function StoryForm({
  ...
  fields: StoryDraft;
  onChange: (fields: StoryDraft) => void;
  onConfirm: () => void;
  onCancel: () => void;
}) {
      ...
      <div className="flex gap-3">
        ...
        >
          {fields.thumbnail ? (
            ...
            <div className="flex h-[152px] w-[96px] items-center justify-center rounded-2xl border border-dashed border-border text-foreground-subtle transition-colors hover:border-accent/50 hover:text-accent">
